...
class BridgeApp(tk.Tk):
    ...
    def _start_backend_worker(self, backend_cmd):
        stdout_handle = None
        stderr_handle = None
        try:
            try:
    ...
    def _clear_session_tokens(self):
        ...
        tok["session_prompt_tokens"] = 0
        tok["session_completion_tokens"] = 0
        if "session_saved_tokens" in tok:
            tok["session_saved_tokens"] = 0
        self._save_json(TOKENS_PATH, tok)
        self._refresh_status_labels()
